...
public class DeepLTranslator implements Translation{
    ...
    public DeepLTranslator(String targetLangTag, boolean translate, String authKey, LanguageStatisticsProvider languageStatisticsProvider) {
